...
// const FavouriteButton = ({ assetId, size = 20 }: IProps) => {
//   const { userFavAssets, updateFavAsset } = useFavouriteAssets();

//   const isFavourite = userFavAssets.has(assetId);

//   const handleChange = async () => {
//     await updateFavAsset(assetId);
//   };
...
//           {isFavourite ? <FilledStar size={size} /> : <EmptyStar size={size} />}
//         </span>
//       </label>
//     </div>
//   );
